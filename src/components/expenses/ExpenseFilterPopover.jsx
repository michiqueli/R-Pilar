              ...
              <div>
                ...
                {catalogs.types.map(t => (
                  <div key={t.id} className="flex items-center space-x-2 mb-1">
                    <Checkbox
                      checked={localFilters.expense_type_id.includes(t.id)}
                      onCheckedChange={() => handleFilterChange('expense_type_id', t.id)}
                      className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                    />
              ...
              <div>
                ...
                {catalogs.statuses.map(s => (
                  <div key={s.id} className="flex items-center space-x-2 mb-1">
                    <Checkbox
                      checked={localFilters.payment_status_id.includes(s.id)}
                      onCheckedChange={() => handleFilterChange('payment_status_id', s.id)}
                      className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                    />
              ...
              <div>
                ...
                <div className="max-h-32 overflow-y-auto space-y-2">
                  {catalogs.providers.map(p => (
                    <div key={p.id} className="flex items-center space-x-2">
                      <Checkbox
                        checked={localFilters.provider_id.includes(p.id)}
                        onCheckedChange={() => handleFilterChange('provider_id', p.id)}
                        className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                      />
                      <Label className="text-sm font-normal truncate">{p.name}</Label>
                    </div>
